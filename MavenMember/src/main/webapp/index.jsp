...
<html>
	<head>
		...
		<%
			...
			// 로그인 O -> loginMember : 로그인한 회원의 정보 null 아님.
		%>
	<body>
				...
				<%
					if(member != null){
						...
						if(member.getEmail().equals("admin")){
							out.print("<a href='select.jsp'>회원전체정보</a>");
						}
			...
			<section id="banner" class="major">
				...
				<header class="major">
					...
					<%
						...
						if(member != null) {
							out.print(member.getEmail()+ "님 환영합니다.");
						}else{
							out.print("로그인 해주세요");
						}
					%>
				...
				<section class="split">
					<section>
						<div class="contact-method">
							...
							<h3>Email</h3>
							<!-- <a href="#"><%
							if(member != null)out.print(member.getEmail()); 
							%></a> -->
					...
					<section>
						<div class="contact-method">
							...
							<h3>Phone</h3>
							<span><%
							if(member != null)out.print(member.getTel()); 
							%></span>
					...
					<section>
						<div class="contact-method">
							...
							<h3>Address</h3>
							<span><%
							if(member != null)out.print(member.getAddress()); 
							%></span>
